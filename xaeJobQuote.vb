Public Class xaeJobQuote
    ...
    Private Sub bbiAddLine_ItemClick(ByVal sender As System.Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles bbiAddLine.ItemClick
        ...
        xaejl = New xaeJobLineLite With {.Record = New API.JobLine With {.JobLineDate = Now, .Job = CType(BindingSource.Current, API.Job), .WorkCentreCategory = Record.WorkCentreCategory}}
        'End Using
