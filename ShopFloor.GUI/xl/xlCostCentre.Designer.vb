...
Partial Class xlCostCentre
    Inherits UniSource.ShopFloor.GUI.xlgCostCentre
    ...
    Private Sub InitializeComponent()
        ...
        'GridView1
        '
        Me.GridView1.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colCode, Me.colDescription, Me.colTransactionCode, Me.colID})
