    ...
    Public Class ViewJobDrawings
        ...
        Protected Overrides Sub Action()
            ...
            If bc.AddCheckOut("Job", Jobs(0).ID) Then
                ...
                xaej.GridView1.OptionsBehavior.ReadOnly = True
                xaej.ShowDialog()
        ...
        Public Overrides ReadOnly Property Description As String
            Get
                Return "View the Job Drawing in Read-Only mode."
            End Get
        End Property

        Public Overrides ReadOnly Property ID As API.JobFunction
            Get
                Return API.JobFunction.ViewDrawing
            End Get
        End Property
