...
Partial Class xaePartGroup
    Inherits UniSource.ShopFloor.GUI.xaegPartGroup
    ...
    Private Sub InitializeComponent()
        ...
        'BindingSource
        '
        Me.BindingSource.DataSource = GetType(UniSource.ShopFloor.API.PartGroup)
        '
        'DataLayoutControl1
        '
