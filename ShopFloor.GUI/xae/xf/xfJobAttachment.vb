Public Class xfJobAttachment
    ...
    Public Sub New(ByVal job As API.Job)
        ...
        Me.BindingSource.DataSource = Me.job.AttachmentCollection

        Me.Text = String.Format("{0} Attachments", Me.job.JobNumber)
    End Sub
    ...
    Private Sub AttachmentCollectionBindingSource_AddingNew(sender As System.Object, e As System.ComponentModel.AddingNewEventArgs) Handles BindingSource.AddingNew
        Dim att As New API.JobAttachment With {.Job = Me.job}
        ...
        If ofd.ShowDialog = Windows.Forms.DialogResult.OK Then
            For Each filepath As String In ofd.FileNames
                If String.IsNullOrEmpty(att.Name) Then
                    ...
                    End Try
                Else
                    Dim att2 As New API.JobAttachment With {.Job = Me.job}
    ...
    Private Sub SaveAttachment()
        Dim att As API.JobAttachment = TryCast(lvAttachments.GetFocusedRow, API.JobAttachment)
    ...
    Private Sub xfJobAttachment_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Try
