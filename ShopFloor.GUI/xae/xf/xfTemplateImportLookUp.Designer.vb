...
Partial Class xfTemplateImportLookUp
    ...
    Private Sub InitializeComponent()
        ...
        'JobBindingSource
        '
        Me.JobBindingSource.DataSource = GetType(UniSource.ShopFloor.API.JobTemplate)
        '
        'lkpQuickLookup
        '
        ...
        Me.lkpQuickLookup.Properties.Columns.AddRange(New DevExpress.XtraEditors.Controls.LookUpColumnInfo() {New DevExpress.XtraEditors.Controls.LookUpColumnInfo("TemplateNumber", "Template Number", 120, DevExpress.Utils.FormatType.None, "", True, DevExpress.Utils.HorzAlignment.Near), New DevExpress.XtraEditors.Controls.LookUpColumnInfo("Description1", 600, "Description")})
        Me.lkpQuickLookup.Properties.DataSource = Me.JobBindingSource
        Me.lkpQuickLookup.Properties.DisplayMember = "TemplateNumber"
        Me.lkpQuickLookup.Properties.NullText = "(Please Select a Template)"
        ...
        Me.Name = "xfTemplateImportLookUp"
        Me.Text = "Template Import"
