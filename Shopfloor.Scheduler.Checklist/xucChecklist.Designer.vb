...
Partial Class xucChecklist
    ...
    Private Sub InitializeComponent()
        ...
        '
        Me.ChecklistBindingSource.DataSource = GetType(API.Checklist)
        '
        'LayoutControlGroup1
        '
        ...
        '
        'ChecklistLogBindingSource
        '
        Me.ChecklistLogBindingSource.DataSource = GetType(UniSource.ShopFloor.Scheduler.Checklist.API.ChecklistLog)
        '
        'xucChecklist
        '
