...
Partial Public MustInherit Class LookupValueBase
    ...
    <BelongsTo("LookupID", Cascade:=CascadeEnum.SaveUpdate, NotFoundBehaviour:=NotFoundBehaviour.Ignore)>  _
...
Partial Public MustInherit Class LookupBase
    ...
    <Xml.Serialization.XmlIgnore(),  _
     HasMany(GetType(LookupValue), Cascade:=ManyRelationCascadeEnum.AllDeleteOrphan, ColumnKey:="LookupID", Lazy:=true, Table:="ussSSLookupValues", NotFoundBehaviour:=NotFoundBehaviour.Ignore)>  _
...
Partial Public MustInherit Class ChecklistOptionLogBase
    ...
    <BelongsTo("ChecklistTaskID", NotFoundBehaviour:=NotFoundBehaviour.Ignore)>  _
    ...
    <BelongsTo("ChecklistID", NotFoundBehaviour:=NotFoundBehaviour.Ignore)>  _
    ...
    <BelongsTo("ChecklistLogID", NotFoundBehaviour:=NotFoundBehaviour.Ignore)>  _
...
<ActiveRecord("ussChecklistTaskLog", Schema:="dbo", BatchSize:=100)>  _
...
Partial Public MustInherit Class ChecklistOptionBase
    ...
    <Xml.Serialization.XmlIgnore(),  _
     HasMany(GetType(ChecklistChecklistOption), ColumnKey:="ChecklistTaskID", Lazy:=true, Table:="ussChecklistChecklistTasks", NotFoundBehaviour:=NotFoundBehaviour.Ignore)>  _
    ...
    Public Overridable Property Comment() As String
        ...
        Set
            If (_comment <> value) Then
                Me._comment = value
                Me.NotifyPropertyChanged("Comment")
            End If
        End Set
    End Property
    
    <Xml.Serialization.XmlIgnore(),  _
     HasMany(GetType(ChecklistOptionLog), Cascade:=ManyRelationCascadeEnum.AllDeleteOrphan, ColumnKey:="ChecklistLogID", Lazy:=true, NotFoundBehaviour:=NotFoundBehaviour.Ignore)>  _
...
Partial Public MustInherit Class ChecklistChecklistOptionBase
    ...
    <BelongsTo("ChecklistID", Cascade:=CascadeEnum.All, NotFoundBehaviour:=NotFoundBehaviour.Ignore)>  _
    Public Overridable Property Checklist() As Checklist
        Get
            Return Me._checklist
        End Get
...
Partial Public MustInherit Class ChecklistBase
    ...
    Private _isCommentEnabled As System.Nullable(Of Boolean)
    ...
    Public Overridable Property IsCommentEnabled() As System.Nullable(Of Boolean)
        Get
            Return Me._isCommentEnabled
        End Get
        Set
            If ((_isCommentEnabled <> value)  _
                        Or (_isCommentEnabled Is Nothing)) Then
                Me._isCommentEnabled = value
                Me.NotifyPropertyChanged("IsCommentEnabled")
            End If
        End Set
    End Property
    
    <Xml.Serialization.XmlIgnore(),  _
     HasMany(GetType(ChecklistLog), ColumnKey:="ChecklistID", Lazy:=true, NotFoundBehaviour:=NotFoundBehaviour.Ignore)>  _
    ...
    <Xml.Serialization.XmlIgnore(),  _
     HasMany(GetType(ChecklistChecklistOption), Cascade:=ManyRelationCascadeEnum.All, ColumnKey:="ChecklistID", Lazy:=true, Table:="ussChecklistChecklistTasks", NotFoundBehaviour:=NotFoundBehaviour.Ignore)>  _
    Public Overridable Property ChecklistChecklistTasks() As IList(Of ChecklistChecklistOption)
        Get
            Return Me._checklistChecklistTasks
        End Get
    ...
    <BelongsTo("TypeID", Cascade:=CascadeEnum.SaveUpdate, NotFoundBehaviour:=NotFoundBehaviour.Ignore)>  _
