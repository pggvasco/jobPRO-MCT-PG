...
Partial Class xlChecklistOption
    Inherits UniSource.Checklist.GUI.xlgChecklistOption
    ...
    Private Sub InitializeComponent()
        ...
        Me.gvChecklistOption.OptionsBehavior.AllowIncrementalSearch = True
        Me.gvChecklistOption.OptionsBehavior.Editable = False
        Me.gvChecklistOption.OptionsBehavior.ReadOnly = True
        Me.gvChecklistOption.OptionsDetail.EnableMasterViewMode = False
        '
        'colDescription
        '
