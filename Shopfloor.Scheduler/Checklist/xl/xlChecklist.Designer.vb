...
Partial Class xlChecklist
    Inherits UniSource.Checklist.GUI.xlgChecklist
    ...
    Private Sub InitializeComponent()
        ...
        Me.gvChecklist.OptionsBehavior.AllowIncrementalSearch = True
        Me.gvChecklist.OptionsBehavior.Editable = False
        Me.gvChecklist.OptionsBehavior.ReadOnly = True
        Me.gvChecklist.OptionsDetail.EnableMasterViewMode = False
        Me.gvChecklist.OptionsDetail.ShowDetailTabs = False
        Me.gvChecklist.OptionsDetail.SmartDetailExpand = False
        '
        'colCode
        '
